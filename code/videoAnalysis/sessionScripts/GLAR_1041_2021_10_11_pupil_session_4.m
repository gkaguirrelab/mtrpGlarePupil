%% GLAR_1041_2021-10-11_pupil_session_4
%
...
pathParams.Subject = 'GLAR_1041';
pathParams.Date = '2021-10-11';
...
% Mask bounds
glintFrameMask = [206   211   243   405];
pupilFrameMask = [175   193   234   377];
...
% left
candidateThetas = pi/4;
minRadiusProportion = 0.9;
cutErrorThreshold = 0.9;
