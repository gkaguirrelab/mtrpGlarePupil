%% GLAR_01_2020_12_22_pupil_session_2
%
...
%% Analysis Notes
% default pupilRangeSets = [40 60]
% pupilRangeSets for vids = [2, 8, 9, 10, 12, 14, 22, 33, 34, 38] = [40
% 50]


%% Videos
vids = [4, 6, 12, 15, 20, 21, 38, 40];
% vids = 1:42;
...
pupilFrameMask = [115   219   251   295];
